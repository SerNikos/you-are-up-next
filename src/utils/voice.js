...
// Έξυπνος τεμαχισμός που σέβεται τις προτάσεις (τελείες, ερωτηματικά)
...
export const toggleSpeech = (i18nLanguage = "el") => {
  ...
  // --- ΒΕΛΤΙΩΜΕΝΗ ΛΟΓΙΚΗ ΓΙΑ ΠΑΥΣΕΙΣ & ΚΑΘΑΡΙΣΜΟ ---
  // 1. Μετατρέπουμε τις ΔΙΠΛΕΣ αλλαγές γραμμής σε τελεία (για φυσική παύση χωρίς να διαβάζει "...")
  let rawText = mainContent.innerText.replace(/\n{2,}/g, ". ");

  // 2. Μετατρέπουμε τις μονές αλλαγές γραμμής σε απλό κενό
  rawText = rawText.replace(/\n/g, " ");

  // 3. Αφαιρούμε τυχόν περιττές πολλαπλές τελείες που μπερδεύουν το TTS
  rawText = rawText.replace(/\.{2,}/g, ".");

  // 4. Καθαρίζουμε το κείμενο από πολλαπλά κενά
